...
print("====================== Support ====================== ")
print("==== Contact: https://www.facebook.com/Duong2512 ====")
...
def read_in_chunks(filePath):
    ...
    if extName in fileByteList:
        ...
        if base64Prefix != None:
            if(base64Prefix == base64PrefixList['.plist']):
                print("sd")
            any = bytes(base64Prefix, 'utf-8')
            base64Str = any + base64Str
